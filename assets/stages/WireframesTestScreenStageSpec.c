...
PositionedEntityROMSpec WireframesTestScreenStageEntities[] =
{
...
PositionedEntityROMSpec WireframesTestScreenStageUiEntities[] =
{
	{NULL, {0,0,0,0}, 0, NULL, NULL, NULL, false},
};
...
FontROMSpec* const WireframesTestScreenStageFonts[] =
{
	NULL
};

SoundROM* WireframesTestScreenStageSounds[] =
{
...
StageROMSpec WireframesTestScreenStage =
{
	// allocator
	__TYPE(Stage),
	...
	{
		// fonts to preload
		(FontSpec**)WireframesTestScreenStageFonts,
		...
		// background music
		(Sound**)WireframesTestScreenStageSounds,
	},
	...
	// entities
	{
		// ui
		{
			(PositionedEntity*)WireframesTestScreenStageUiEntities,
			__TYPE(UIContainer),
		},

		// children
		(PositionedEntity*)WireframesTestScreenStageEntities,
	},
